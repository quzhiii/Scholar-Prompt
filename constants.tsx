    ...
    templateGenerator: (v, lang) => {
      ...
      if (lang === 'cn') {
        return buildOxfordPrompt(
          ...
          "我已经通过 file_ids 上传了多个 PDF 文献，请直接读取并进行深度批判性分析，采用结构化方法识别研究空白并提出可研究问题。注意：文献内容已在系统中，请立即开始分析，不要说无法访问。",
          `研究领域：${v.topic}。${fileContext} 你可以完全访问已上传的文件内容。必须严格基于提供的材料，引用具体段落/数据支撑观点。保持学术严谨性，避免主观臆断。`,
      ...
      return buildOxfordPrompt(
        ...
        "I have uploaded multiple PDF papers via file_ids. Please directly read and conduct in-depth critical analysis using a structured approach to identify research gaps and formulate researchable questions. Note: The files are already in the system - start analysis immediately without saying you cannot access them.",
        `Research Topic: ${v.topic}. ${fileContext} You have full access to the uploaded file contents. Base analysis strictly on provided materials with specific citations. Maintain academic rigor and avoid speculation.`,
